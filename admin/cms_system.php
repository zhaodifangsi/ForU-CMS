...
if (isset($_POST['submit'])) {
  ...
  $data['s_seoname'] = $_POST['s_seoname'];
  $data['s_keywords'] = $_POST['s_keywords'];
  $data['s_description'] = $_POST['s_description'];
  $data['s_copyright'] = $_POST['s_copyright'];
  $data['s_code'] = $_POST['s_code'];
  $data['s_user'] = $_POST['s_user'];
  $data['s_comment'] = $_POST['s_comment'];
  $data['s_state'] = $_POST['s_state'];
  if(CART) $data['s_freight'] = $_POST['s_freight'];
      ...
      <div class="am-u-sm-12 am-padding-top">
        ...
        <section class="am-panel am-panel-default">
          ...
          <form action="" method="post" class="am-form">
            ...
            <main class="am-tabs am-margin" data-am-tabs data-am-tabs-noswipe="1">
                ...
                <section class="am-tab-panel am-fade am-in am-active" id="tab1">
                  ...
                  <div class="am-form-group">
                    ...
                    <select name="s_user" id="s_user">
                      <option value="0" <?php echo $row['s_user'] == 0 ? 'selected = "selected"' :'';?>>开启</option>
                      <option value="1" <?php echo $row['s_user'] == 1 ? 'selected = "selected"' :'';?>>关闭</option>
                    </select>
                  </div>
