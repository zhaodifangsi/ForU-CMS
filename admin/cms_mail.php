...
if(@$_POST['size']){
  setcookie('cms[mail_size]', str_safe($_POST['size']), time()+COOKIE_EXPIRE);
  href('cms_mail.php');
}
$size = @$_COOKIE['cms']['mail_size'] ? $_COOKIE['cms']['mail_size'] : 20;
?>
<!DOCTYPE html>
      ...
      <div class="am-u-sm-12 am-padding-top">
        ...
        <section class="am-panel am-panel-default">
          ...
          <main class="am-panel-bd am-collapse am-text-break am-in" id="collapse-panel-1">
            ...
            <?php
            $page = new Page($size);
            $page->handle($db->getOne("SELECT COUNT(*) FROM subscribe"));
            $res = $db->getAll("SELECT sub_mail FROM subscribe ORDER BY id DESC LIMIT ".$page->page_start.",".$page->page_size);
