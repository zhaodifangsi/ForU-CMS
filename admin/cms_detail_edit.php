...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE detail SET ".arr_update($data)." WHERE id = " . $_GET['id'];
  $dataops->ops($sql, '信息编辑['.$_GET['id'].']', 1);
}

$res = $db->getRow("SELECT * FROM detail WHERE id = ".$_GET['id']);
// 权限限制
$state = 0;
if ($cids) {
  $arr = explode(',', $cids);
          ...
          <form action="" method="post" class="am-form">
            <main class="am-panel-bd am-panel-bordered am-collapse am-in" id="collapse-panel-2">
              <?php
                if($row = $res){
              ?>
              <div class="am-tabs am-margin" data-am-tabs data-am-tabs-noswipe="1">
                ...
                <div class="am-tabs-bd">
                  <section class="am-tab-panel am-fade am-in am-active" id="tab1">
                    ...
                    <div class="am-form-group">
                      <label for="d_code">代码</label>
                       <textarea id="d_code" name="d_code" value=“<?php echo $row['d_code'];?>”></textarea>
                    </div>
                    <div class="am-form-group">
